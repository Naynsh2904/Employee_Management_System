      ...
      <form className='flex flex-wrap w-full items-start justify-between p-12'>
        <div className='w-1/2'>
          ...
          <div>
            ...
            <input className='text-white text-md py-2 px-3 mb-3 outline-none bg-transparent border-[1px] w-4/5 rounded-lg  placeholder:text-gray' type="text" placeholder='employee Name' />
          </div>
          <div>
